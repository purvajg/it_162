...
$siteKey = "6LeWETsaAAAAAKOmh8HgES_3fbUWiSHhhj3dWFCz";
$secretKey = "6LeWETsaAAAAAIuS26-4ozAEkhB-bzqlWDtQI8aV";
...
//functions below----
    ...
    // $toName = "CLIENT NAME HERE"; //place your client's name here
    // $website = "CLIENT WEBSITE NAME HERE";  //place NAME of your client's 
    // echo loadContact('form.php','new_feedback.php');//custom feedback page
